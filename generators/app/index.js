...
module.exports = class extends Generator {
  async prompting() {
    ...
    this.answers = await this.prompt([
      ...
      { store: defaultStore, type: "confirm", name: "LA_lists_uses_subdomain", message: function(a) { return defUseSubdomainPrompt(a, "specieslists"); }, default: function(a) { return defUseSubdomain(a); } },
      { store: defaultStore, type: "input", name: "LA_lists_hostname", message: "LA specieslists hostname", default: function(a) { return a.LA_lists_uses_subdomain ? `lists.${a.LA_domain}`: a.LA_domain; } },
      { store: defaultStore, type: "input", name: "LA_lists_path", default: "/specieslists", when: function(a) { return !a.LA_lists_uses_subdomain; } },
      ...
      { store: defaultStore, type: "confirm", name: "LA_regions_uses_subdomain", message: function(a) { return defUseSubdomainPrompt(a, "regions"); }, default: function(a) { return defUseSubdomain(a); } },
      { store: defaultStore, type: "input", name: "LA_regions_hostname", message: "LA regions hostname", default: function(a) { return a.LA_regions_uses_subdomain ? `regions.${a.LA_domain}`: a.LA_domain; } },
      { store: defaultStore, type: "input", name: "LA_regions_path", default: "/regions", when: function(a) { return !a.LA_regions_uses_subdomain; } },
      ...
      { store: defaultStore, type: "input", name: "LA_cas_hostname", message: "LA CAS hostname", default: function(a) { return `auth.${a.LA_domain}`; }},

      { store: defaultStore, type: "confirm", name: "LA_enable_ssl", message: "Enable SSL? (Warn: this only set the urls correctly, but it doesn't manage the certicates)", default: false },

      { store: defaultStore, type: "confirm", name: "LA_use_CAS", message: "Use CAS Auth service?", default: false },
      { store: defaultStore, type: "confirm", name: "LA_use_regions", message: "Use regions service?", default: false },
      { store: defaultStore, type: "confirm", name: "LA_use_spatial", message: "Use spatial service?", default: false },
      { store: defaultStore, type: "confirm", name: "LA_use_species_lists", message: "Use specieslists service?", default: false }
  ...
  writing() {
    ...
    if (this.answers.LA_lists_uses_subdomain)    { this.answers.LA_lists_path = ""; }
    if (this.answers.LA_images_uses_subdomain)    { this.answers.LA_images_path = ""; }
    if (this.answers.LA_regions_uses_subdomain)    { this.answers.LA_regions_path = ""; }
    ...
    this.answers.LA_urls_prefix = this.answers.LA_enable_ssl ? 'https://' : 'http://';
