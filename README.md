...
You will need also to clone or download the [ala-install](https://github.com/AtlasOfLivingAustralia/) repository. We recommend to use the stable `v2.0.10` release, for instance with:

```bash
git clone --depth 1 --branch v2.0.10 https://github.com/AtlasOfLivingAustralia/ala-install.git
```
